...
public class PointsActivity extends Activity implements AbsListView.MultiChoiceModeListener {
        ...
        switch (arg1.getItemId()) {
            ...
            case R.id.action_edit_point:
                ...
                if(selected.size()==1){
                    ...
                    Toast.makeText(getApplicationContext(), getString(R.string.not_a_point_is_selected_message), Toast.LENGTH_SHORT).show();
                }
                return true;
            default:
                return false;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 2 && resultCode == Activity.RESULT_OK){
            ...
            listView.setMultiChoiceModeListener(this);
            listView.setChoiceMode(listView.CHOICE_MODE_MULTIPLE_MODAL);
            Toast.makeText(getApplicationContext(), getString(R.string.new_point_added_message)+m.getPointlatitude()+" "+m.getPointlongitude(), Toast.LENGTH_SHORT).show();
        ...
        if(requestCode == 4 && resultCode == 4){
            ...
            listView.setMultiChoiceModeListener(this);
            listView.setChoiceMode(listView.CHOICE_MODE_MULTIPLE_MODAL);
            Toast.makeText(getApplicationContext(), getString(R.string.point_has_been_modified_message), Toast.LENGTH_SHORT).show();
            setResult(3);
        }
    }
